...
public class Signup extends JFrame implements ActionListener {
    ...
    public Signup() {
        ...
        // Logo label (renamed so it doesn't clash with l11 instance label)
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        // Insert using PreparedStatement (safer)
        try {
            Conn c1 = new Conn();
            if (c1.c == null) {
                JOptionPane.showMessageDialog(null, "Database connection failed. Check Conn.java settings.");
                return;
            }
    ...
    public static void main(String[] args) {
        // Optionally set look-and-feel here
